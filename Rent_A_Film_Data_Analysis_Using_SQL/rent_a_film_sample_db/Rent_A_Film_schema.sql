...
DROP SCHEMA IF EXISTSrent-a-film;
CREATE SCHEMArent-a-film;
USErent-a-film;
...
GROUP_CONCAT(DISTINCT CONCAT(c.name, ': ',
		(SELECT GROUP_CONCAT(f.title ORDER BY f.title SEPARATOR ', ')
                    FROMrent-a-film.film f
                    INNER JOINrent-a-film.film_category fc
                      ON f.film_id = fc.film_id
                    INNER JOINrent-a-film.film_actor fa
...
AS film_info
FROMrent-a-film.actor a
LEFT JOINrent-a-film.film_actor fa
  ON a.actor_id = fa.actor_id
LEFT JOINrent-a-film.film_category fc
  ON fa.film_id = fc.film_id
LEFT JOINrent-a-film.category c
